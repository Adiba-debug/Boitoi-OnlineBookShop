...
//             cartItem.className =
//                 "bg-white p-5 rounded-lg shadow mb-4 flex items-center justify-between";
...
//                             <button
//                                 class="decrease-btn bg-gray-300 px-3 py-1 rounded">
...
//                             <button
//                                 class="increase-btn bg-gray-300 px-3 py-1 rounded">
...
//                         <button
//                             class="remove-btn bg-red-500 text-white px-4 py-2 rounded mt-3 hover:bg-red-600">
...
//         totalDiv.className =
//             "bg-white p-6 rounded-lg shadow mt-6 text-right";
...
//             <a
//                 href="index.html"
//                 class="inline-block bg-gray-600 text-white px-6 py-3 rounded mt-4 mr-2 hover:bg-gray-700">
...
async function loadCart() {
    ...
    try {
        ...
        const checkoutBtn = totalDiv.querySelector("#checkoutBtn");
        ...
        checkoutBtn.addEventListener("click", async function () {
            ...
            // Double click আটকানোর জন্য button disable
            ...
            try {
                ...
                // Cart খালি হয়ে গেছে, তাই cart page আবার load
